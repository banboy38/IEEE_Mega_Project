...
<html lang="en-gb">
    ...
    <body style="background-color:aliceblue;font-family:Verdana;color:darkslategray">
            <h1 style="text-align:center;margin-top:30px">Pharmaceutical Department</h1>
         ...
         <div id="link" style="text-align:center;margin-bottom:60px" ><a href="prod.php">Click for Production Department student list</a></div>
    </body>   
</html>
