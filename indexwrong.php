...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/SAVE.jpg');">
			<div class="wraplogin100">
				<form class="login100-form validate-form" action="process.php" method="post">
					...
					<div style="font-size:10px;text-align:center;color:maroon;background-color:rgba(255,182,193,0.3);border-radius:3px;margin-left:80px;margin-right:80px">
